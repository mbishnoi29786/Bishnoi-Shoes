...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="number" name="product_size" placeholder="Size" style="width:250px;" min="1" max="12" required></td>
							</tr>
							<tr>
	...
	<div id="leftnav">
		<ul>
			<li><a href="admin_home.php" class="dashboard">Dashboard</a></li>
			<li><a href="admin_home.php">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px;">Features</a></li>
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;"id=active;>Basketball</a></li>
